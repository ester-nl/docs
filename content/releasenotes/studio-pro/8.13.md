...
### Known Issues
* An Oops dialog occurs when attempting to commit after renaming (Ticket 69006) or deleting a module (Ticket 107979).
    * Workaround: Re-adding an empty folder named after the module (e.g. "MyFirstModule") to the javasource and javascriptsource folders in the project will allow you to commit to the repository again.
